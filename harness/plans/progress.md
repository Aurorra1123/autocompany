...
Initialized the `autocompany` harness baseline. The content is still a template and must be adapted to the real repo goal, ideas, tasks, standards, and evidence.
