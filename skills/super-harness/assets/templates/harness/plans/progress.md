...
5. 下次实验或 benchmark 使用 `python3 harness/scripts/harness_run.py --title "..." -- <command>` 记录
6. 需要跨人/跨分支对比时，使用 `python3 harness/scripts/compare_experiments.py --title "..." --evidence <record-id>` 生成结论
7. 结论经过 review 后，使用 `python3 harness/scripts/promote_finding.py --title "..." --comparison <comparison-id>` 晋升到 findings
